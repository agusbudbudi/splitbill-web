      ...
      <div className="relative w-full flex-1 flex flex-col">
        ...
        <main className="relative z-10 flex-1 flex flex-col">
          <div className="px-3 pt-3">
            <BillSummary ref={billSummaryRef} billData={bill} isPublic={isPublic} hideShareActions hideMonitorButton />
          </div>

          {/* Share section — gradient background to visually separate from detail above */}
          <div className="relative px-3 pt-4 pb-8 space-y-4 rounded-t-lg overflow-hidden">
            <div className="absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-primary via-primary/50 to-transparent pointer-events-none z-0" />
