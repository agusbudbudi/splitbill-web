    ...
    <>
      ...
      >
        ...
        >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-2 max-w-[400px]">
                  ...
                  <p className="text-sm text-foreground/70 font-medium leading-relaxed">
                    Bagi tagihan{" "}
                    <span className="text-primary font-bold">sat set</span>,
                    hitung patungan{" "}
                    <span className="text-primary font-bold">anti ribet</span> &{" "}
                    <span className="text-primary font-bold">akurat</span>. Link
                    pembayaran langsung spill! 💸✨
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Footer - Redesigned for Premium Highlight (Compact & Brand Blue) */}
          <div className="mt-auto">
            <div
              onClick={handleShare}
              className="relative overflow-hidden group cursor-pointer active:scale-[0.98] transition-all duration-500 rounded-md"
            >
              {/* Solid Brand Primary Background */}
              <div className="absolute inset-0 bg-primary rounded-md shadow-[0_8px_30px_-10px_rgba(71,159,234,0.4)] transition-all duration-500" />

              {/* Subtle Overlay for Glass Effect */}
              <div className="absolute inset-0 bg-white/5 backdrop-blur-[1px] rounded-md" />

              <div className="relative z-10 p-4 flex flex-col gap-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-white shadow-lg flex items-center justify-center text-primary group-hover:rotate-12 transition-all duration-500 shrink-0">
                      <Share2 className="w-4.5 h-4.5 stroke-[2.5px]" />
                    </div>
                      ...
                      <p className="text-[10px] text-white/80 font-medium leading-tight">
                        {copied ? (
                          <span className="flex items-center gap-1.5 font-bold text-white">
                            ...
                            <span>Link Berhasil Di-copy! 🚀</span>
                          </span>
                        ) : (
                  ...
                  <div className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center group-hover:translate-x-1 transition-transform shrink-0">
            ...
            <div className="flex items-center gap-2 py-4 px-1">
              <Link
                href="/privacy"
                className="text-xs text-muted-foreground/40 hover:text-primary hover:underline transition-colors"
              >
                Kebijakan Privasi
              </Link>
              <Link
