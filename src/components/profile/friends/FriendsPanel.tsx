...
export function FriendsPanel() {
  ...
  return (
    <div className="w-full max-w-[600px] mx-auto flex-1 flex flex-col relative">
      <div className="space-y-4 pb-4">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full h-12 pl-10 pr-4 bg-white border border-primary/10 rounded-sm text-sm font-medium transition-all focus-visible:outline-none focus-visible:border-primary/30 focus-visible:ring-2 focus-visible:ring-primary/10"
          />
        </div>
...
const FriendCard = ({
  ...
  return (
    <Card
      onClick={onEdit}
      className="shadow-md overflow-hidden relative hover:bg-accent/5 transition-colors group active:scale-[0.99] cursor-pointer"
    >
