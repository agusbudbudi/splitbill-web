...
export function SplitLaterPanel() {
  ...
  const handleSave = async (skipPhoto: boolean = false) => {
    ...
    try {
      ...
      resetForm();
      router.push(`/member/split-later/${bucketId}`);
    } catch (err: any) {
    ...
    return (
      <div className="w-full max-w-[600px] mx-auto space-y-6">
        <button
          ...
          onClick={() => {
            if (step > 1) {
              router.replace(`/member/split-later?step=${step - 1}`);
            } else {
              router.replace("/member/split-later");
            }
          }}
        ...
        <div className="space-y-8 pb-8">{renderStepContent()}</div>
        ...
        <div className="sticky bottom-4 z-30">
          {step === 1 && (
            <Button
              ...
              onClick={() => {
                ...
                router.replace("/member/split-later?step=2");
              }}
          ...
          {step === 2 && (
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => router.replace("/member/split-later?step=1")}
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  router.replace("/member/split-later?step=3");
                }}
          ...
          {step === 3 && (
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => router.replace("/member/split-later?step=2")}
                className="flex-1 h-14 rounded-md bg-white border border-primary/20 text-primary text-base font-bold active:scale-95 transition-all cursor-pointer"
              >
                Kembali
              </button>
              <Button
                ...
                onClick={() => {
                  ...
                  router.replace("/member/split-later?step=4");
                }}
  ...
  return (
    <div className="w-full max-w-[600px] mx-auto space-y-6">
      ...
      <FeatureBanner
        ...
        onCtaClick={(e) => {
          e.preventDefault();
          router.push("/member/split-later?step=1");
        }}
      />
      ...
      {buckets.length === 0 ? (
        <EmptyState
          ...
          action={
            <Button
              onClick={() => router.push("/member/split-later?step=1")}
