  ...
  return (
    <div className="space-y-3">
      <button
        ...
        className={cn(
          "w-full flex items-center justify-between p-4 rounded-lg border transition-all active:scale-[0.99] cursor-pointer",
          isSavedExpanded
            ? "bg-primary/5 border-primary/20"
            : "bg-white hover:bg-primary/5 border-primary/10",
        )}
      >
