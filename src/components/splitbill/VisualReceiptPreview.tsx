...
interface VisualReceiptPreviewProps {
  bottomClass?: string;
}

export const VisualReceiptPreview = ({ bottomClass = "bottom-24" }: VisualReceiptPreviewProps) => {
  ...
  return (
    <>
      ...
      <div className={cn("fixed left-4 z-40 md:left-[calc(50vw-300px+16px)]", bottomClass)}>
        <button
